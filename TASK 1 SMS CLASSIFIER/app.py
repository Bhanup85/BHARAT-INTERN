...
tfidf = pickle.load(open(r"C:\Users\Dell\Downloads\Internship\bharath intern\sms classifier\vectorizer.pkl", 'rb'))
model = pickle.load(open(r"C:\Users\Dell\Downloads\Internship\bharath intern\sms classifier\model.pkl", 'rb'))
